    ...
    <div>
      <section class="py-5">
        <div class="container">
          ...
          <div class="row">
            <div 
              class="col-md-4 col-sm-6 mb-4 portfolio-item" 
        ...
        portfolioItems: [
          {
            ...
            image: require('@/assets/individ.jpg'),
            category: 'individual'
          },
          {
            id: 2,
            ...
            image: require('@/assets/Свадьба.jpg'),
            category: 'wedding'
          },
          {
            id: 3,
            ...
            image: require('@/assets/Семейные.jpg'),
            category: 'individual'
          },
          {
            id: 4,
            title: 'Корпоративное мероприятие',
            description: 'Фото с корпоратива',
            image: require('@/assets/HBD.jpg'),
            category: 'events'
          },
          {
            id: 5,
            title: 'Love story',
            description: 'Романтическая съемка пары',
            image: require('@/assets/Lovestory.jpg'),
            category: 'individual'
          },
          {
            id: 6,
            ...
            image: require('@/assets/Partyy.jpg'),
            category: 'events'
          }
        ]
      }
